...
const NavbarLoged = () => {
    return (
        <nav className="navbar px-6 bg-primary text-primary-content">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    >
                        <li>
                            <Link className={route().current('dashboard.index') ? 'bg-primary-focus' : null} href="/dashboard">Dashboard</Link>
                        </li>
                        <li>
                            <Link className={route().current('map.index') ? 'bg-primary-focus' : null} href="/map">Map</Link>
                        </li>
                    </ul>
                </div>
            </div>
